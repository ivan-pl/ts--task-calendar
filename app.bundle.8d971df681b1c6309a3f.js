...
;// CONCATENATED MODULE: ./src/features/calendar/utils/updateHref.ts
/* eslint-disable no-param-reassign */

function updateHref(href, year, month) {
...
;// CONCATENATED MODULE: ./src/features/calendar/createMonthSwitch.ts



function createMonthSwitch(year, month) {
  ...
  const details = createElement("h2", "month-details", null, format(new Date(year, month), "MMMM yyyy"));
...
;// CONCATENATED MODULE: ./src/common/utils/getQueryParams.ts
...
;// CONCATENATED MODULE: ./src/features/calendar/utils/getDate.ts
...
;// CONCATENATED MODULE: ./src/features/navbar/types.ts
/* eslint-disable no-shadow */
let LinkNames;
(function (LinkNames) {
  LinkNames["Calendar"] = "calendar-link";
  LinkNames["List"] = "list-link";
  LinkNames["About"] = "about-link";
})(LinkNames || (LinkNames = {}));
;// CONCATENATED MODULE: ./src/features/navbar/setActive.ts
const activeClass = "nav__link--active";
function setActive(linkName) {
  Array.from(document.getElementsByClassName(activeClass)).forEach(el => el.classList.remove(activeClass));
...
function initApp(navRoot, appRoot) {
  ...
  router.on("/", {
    onEnter: async () => {
      calendar_renderCalendar(appRoot);
  ...
  router.on("/about", {
    onEnter: async () => {
      about_renderAbout(appRoot);
      setActive(LinkNames.About);
    }
  });
  router.on("/list", {
    onEnter: async () => {
      list_renderList(appRoot);
